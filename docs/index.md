# go-ruby-parquet documentation

**Pure-Go (CGO=0), MRI-faithful red-parquet: read/write Apache Parquet as Arrow tables over apache/arrow-go, interoperating with go-ruby-arrow**

`go-ruby-parquet/parquet` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `parquet`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-parquet/parquet`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `parquet`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`parquet`](https://github.com/go-ruby-parquet/parquet) | the library — Ruby's `parquet` in pure Go |
| [`docs`](https://github.com/go-ruby-parquet/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-parquet.github.io`](https://github.com/go-ruby-parquet/go-ruby-parquet.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-parquet/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-parquet/parquet](https://github.com/go-ruby-parquet/parquet).
