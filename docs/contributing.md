...
Contributions are welcome. `go-ruby-parquet/parquet` is built to a small set of
...
The library is in [`github.com/go-ruby-parquet/parquet`](https://github.com/go-ruby-parquet/parquet).
This documentation site is in [`github.com/go-ruby-parquet/docs`](https://github.com/go-ruby-parquet/docs).
